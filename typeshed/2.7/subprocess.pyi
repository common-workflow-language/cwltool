...
from typing import (Sequence, Any, AnyStr, Mapping, Callable, Text, Tuple, IO, Union,
	Optional)
...
def check_call(args: Union[Text, Sequence[Text]],
               bufsize: int = ...,
               executable: str = ...,
               stdin: _FILE = ...,
               stdout: _FILE = ...,
...
def check_output(args: Union[Text, Sequence[Text]],
                 bufsize: int = ...,
                 executable: str = ...,
                 stdin: _FILE = ...,
                 stderr: _FILE = ...,
...
class Popen:
    ...
    def __init__(self,
                 ...
                 close_fds: bool = ...,
                 shell: bool = ...,
                 cwd: Optional[Union[str, Text]] = ...,
                 env: Optional[Union[Mapping[str, str], Mapping[Text, Text]]] = ...,
                 universal_newlines: bool = ...,
