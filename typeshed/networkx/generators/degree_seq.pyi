...
def configuration_model(deg_sequence, create_using: Optional[Any] = ..., seed: Optional[Any] = ...): ...
def directed_configuration_model(in_degree_sequence, out_degree_sequence, create_using: Optional[Any] = ..., seed: Optional[Any] = ...): ...
...
def directed_havel_hakimi_graph(in_deg_sequence, out_deg_sequence, create_using: Optional[Any] = ...): ...
