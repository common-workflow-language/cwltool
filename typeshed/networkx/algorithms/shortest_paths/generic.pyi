...
def shortest_path(G, source: Optional[Any] = ..., target: Optional[Any] = ..., weight: Optional[Any] = ...): ...
def shortest_path_length(G, source: Optional[Any] = ..., target: Optional[Any] = ..., weight: Optional[Any] = ...): ...
