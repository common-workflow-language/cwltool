...
def configuration_model(aseq, bseq, create_using: Optional[Any] = ..., seed: Optional[Any] = ...): ...
...
def preferential_attachment_graph(aseq, p, create_using: Optional[Any] = ..., seed: Optional[Any] = ...): ...
