...
def getexception(): ...
def raise_(tp: Any, value: Optional[Any] = ..., tb: Optional[Any] = ...) -> NoReturn: ...
def raise_from(exc: Any, cause: Any) -> NoReturn: ...
def raise_with_traceback(exc: Any, traceback: Any = ...) -> NoReturn: ...
reraise = raise_
