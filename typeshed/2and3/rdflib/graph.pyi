...
class Graph(Node):
    ...
    def triples(self, xxx_todo_changeme2: Tuple[Optional[Union[Text, Identifier]], Optional[Union[Text, Identifier]], Optional[Union[Text, Identifier]]]) -> Iterator[Tuple[BNode, BNode, BNode]]: ...
    ...
    #@override
    def serialize(self, destination: None = ..., format: str = ..., base: Optional[Any] = ..., encoding: Optional[Any] = ..., **args: Any) -> bytes: ...
    #def serialize(self, destination: Union[Text, IO[Any]] = ..., format: str = ..., base: Optional[Any] = ..., encoding: Optional[Any] = ..., **args: Any) -> None: ...
