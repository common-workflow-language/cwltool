...
class MessageException(Exception):
    ...
    def __init__(
        self, err_msg: Optional[Any] = ..., type: str = ..., **extra_error_info
    ) -> None: ...
...
class ContainerCLIError(Exception):
    ...
    def __init__(
        ...
        subprocess_command: Optional[Any] = ...,
        **kwargs
    ) -> None: ...
...
class ContainerNotFound(Exception):
    ...
    def __init__(
        self, msg: Optional[Any] = ..., container_id: Optional[Any] = ..., **kwargs
    ) -> None: ...

class ContainerImageNotFound(Exception):
    image = ...  # type: Any
    def __init__(
        self, msg: Optional[Any] = ..., image: Optional[Any] = ..., **kwargs
    ) -> None: ...
