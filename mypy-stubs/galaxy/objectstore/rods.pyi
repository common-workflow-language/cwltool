...
from ..objectstore import DiskObjectStore as DiskObjectStore
from ..objectstore import local_extra_dirs as local_extra_dirs
...
class IRODSObjectStore(DiskObjectStore):
    ...
    def __init__(
        self, config, file_path: Optional[Any] = ..., extra_dirs: Optional[Any] = ...
    ) -> None: ...
