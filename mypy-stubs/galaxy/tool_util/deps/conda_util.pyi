...
class CondaContext(installable.InstallableContext):
    ...
    def __init__(
        self,
        conda_prefix: Optional[Any] = ...,
        conda_exec: Optional[Any] = ...,
        shell_exec: Optional[Any] = ...,
        debug: bool = ...,
        ensure_channels: str = ...,
        condarc_override: Optional[Any] = ...,
        use_path_exec: Any = ...,
...
class CondaTarget:
    ...
    channel = ...  # type: Any
    def __init__(
        self, package, version: Optional[Any] = ..., channel: Optional[Any] = ...
    ) -> None: ...
    @property
...
def install_conda(
    conda_context: Optional[Any] = ..., force_conda_build: bool = ...
): ...
def install_conda_target(
    conda_target, conda_context: Optional[Any] = ..., skip_environment: bool = ...
): ...
