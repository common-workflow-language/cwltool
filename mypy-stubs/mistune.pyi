...
class InlineLexer:
    ...
    def setup(
        self, links: Optional[Dict[Any, Dict]], footnotes: Optional[Dict[Text, int]]
    ) -> None: ...
...
class Renderer:
    ...
    def block_code(
        self, code: Text, lang: Any = ...
    ) -> Text: ...  # It seems that lang should be string, however other types are valid as well
    ...
    ) -> Text: ...  # body - same reason as for lang above, and for other Any in this class
