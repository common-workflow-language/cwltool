...
class Graph(Node):
    ...
    def __init__(self, store: Union[Store, str] = 'default', identifier: Node = None,
    ...
    def triples(self, __tuple_arg_2: Tuple[Union[AnyStr, URIRef], AnyStr, Union[AnyStr, URIRef]]) -> Iterator[
    ...
    def serialize(self, destination: Union[str, IO[Any]] = None, format: str = '', base: str = None,
                  encoding: str = None, **args) -> Union[bytes, None]: ...
    ...
    def query(self, query_object, processor: str = '', result: str = '', initNs: Dict = None, initBindings: Dict = None,
              use_store_provided: bool = True, **kwargs) -> Result: ...
